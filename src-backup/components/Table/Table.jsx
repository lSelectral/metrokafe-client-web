...
import { AccountCircleOutlined, ArrowDownwardOutlined, ArrowUpwardOutlined, DeleteOutline } from '@material-ui/icons'
import './Table.scss'
...
export default function Table() {
  ...
  const moveRow = (id, direction) => {
    ...
    console.log(id);
    setSnackbarState({'state': true, 'message': `ID is: ${id} Direction is: ${direction}`})
  ...
  const columns = [
    ...
    /* NOTES COLUMN */
    {
      ...
      renderCell: (params) => {
        return (
          <textarea style={{height:45, resize:'none'}} 
          rows="4" 
